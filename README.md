...
- **Trò chơi:** Trắc nghiệm, Lật thẻ ghép đôi, Nối nhanh, Đúng hay Sai, Mưa từ, Xếp chữ, Xếp câu; có XP, cấp độ, combo, kỷ lục và nhiệm vụ mỗi ngày.
...
| `src/games.js`, `src/games2.js` | Các trò chơi |
